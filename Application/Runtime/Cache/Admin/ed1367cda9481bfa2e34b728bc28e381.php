					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('Advert/add');?>" name="basic_validate" id="signupForm">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="title" id="title" placeholder="输入广告标题" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="subtitle" id="subtitle" placeholder="输入广告子标题" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="linker" id="linker" placeholder="输入联系人" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="phone" id="phone" placeholder="输入手机号码" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio i-checks">
										<input type="radio" name='state' value="1" checked="checked" />开启
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="address" id="address" placeholder="输入地址" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
