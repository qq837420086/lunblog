			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('Said/add');?>" name="basic_validate" id="signupForm">							
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio ">
										<!--<input type="radio" name='s_view' value="1" checked="checked" />是&nbsp;&nbsp;
	                        			<input type="radio" name='s_view' value="0" />否-->
