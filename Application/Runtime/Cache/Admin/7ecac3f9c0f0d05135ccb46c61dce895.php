						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									<a href="<?php echo U('News/index');?>" class="tip-bottom">新闻管理</a> /<a href="<?php echo U('News/editcate');?>" class="current"> 编辑新闻分类</a></p>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="form-wizard" action="<?php echo U('News/editcate',array('id'=>$detail['id']));?>" method="post" class="form-horizontal">
							<div class="form-group">
								<label class="col-sm-2 control-label">分类名称</label>
								<div class="col-sm-6">
									<input type="text" name="catename" value="<?php echo ((isset($detail["catename"]) && ($detail["catename"] !== ""))?($detail["catename"]):''); ?>" placeholder="输入新闻分类名称" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">子标题名称</label>
								<div class="col-sm-6">
									<input type="text" name="subtitle" value="<?php echo ((isset($detail["subtitle"]) && ($detail["subtitle"] !== ""))?($detail["subtitle"]):''); ?>" placeholder="输入新闻子标题名称" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea type="text" name="note"  placeholder="输入备注信息" class="form-control"><?php echo ((isset($detail["note"]) && ($detail["note"] !== ""))?($detail["note"]):''); ?></textarea>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="sort" value="<?php echo ((isset($detail["sort"]) && ($detail["sort"] !== ""))?($detail["sort"]):''); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-danger" href="<?php echo U('Nwes/newscate');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
