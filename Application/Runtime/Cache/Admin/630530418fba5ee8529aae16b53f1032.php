			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('Advert/edit',array('id'=>$detail['id']));?>" name="basic_validate" id="signupForm">
							<div class="form-group">
							...
							<div class="form-group">
				                ...
				                <div class="col-sm-6">                   
				                    <select name="adverttype"  class="form-control m-b chosen-select">
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $detail["adverttype"]): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
				                </div>
				            </div>		            				            				            				            
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div style="width: 200px; height: 110px; float: left;">
										<input type="hidden" name="imageurl" value="<?php echo ((isset($detail["imageurl"]) && ($detail["imageurl"] !== ""))?($detail["imageurl"]):''); ?>" id="data_photo" />
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="linker" id="linker" value="<?php echo ((isset($detail["linker"]) && ($detail["linker"] !== ""))?($detail["linker"]):''); ?>" placeholder="输入联系人" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="phone" id="phone" value="<?php echo ((isset($detail["phone"]) && ($detail["phone"] !== ""))?($detail["phone"]):''); ?>" placeholder="输入手机号码" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio i-checks">
										<?php if($detail['state'] == 1 ): ?><input type="radio" name='state' value="1" checked="checked" />开启
					                        <input type="radio" name='state' value="0" />关闭<?php endif; ?>
					                    <?php if($detail['state'] == 0 ): ?><input type="radio" name='state' value="1" />开启
					                        <input type="radio" name='state' value="0" checked="checked"  />关闭<?php endif; ?>
	                        		</div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="address" id="address" value="<?php echo ((isset($detail["address"]) && ($detail["address"] !== ""))?($detail["address"]):''); ?>" placeholder="输入地址" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
