...
$(document).ready(function(){
	$("#loginout").click(function(){
						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									<a href="#" class="tip-bottom"> 本地生活</a> / <a href="<?php echo U('Life/index');?>" class="tip-bottom">分类管理</a></p>
							</li>
						</ul>
					</div>
				</div>
		...
		<a href="<?php echo U('Life/addtype');?>" class="btn btn-primary">添加一级分类</a>
		<br />
		<br />
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($list1)): foreach($list1 as $key=>$var1): ?><tr class="long-td">
			                            <td style="text-align: center;"><?php echo ($var1["cate_id"]); ?></td>
			                            <td style="text-align: center;"><?php echo ($var1["cate_name"]); ?></td>
			                            <td style="text-align: center;"><?php echo ($var1["orderby"]); ?></td>
			                            <td style="text-align: center;">
											<a href="<?php echo U('life/addSubtype',array('cate_id'=>$var1['cate_id']));?>">添加子分类</a>&nbsp;&nbsp;| 
											<a href="<?php echo U('life/edittype',array('cate_id'=>$var1['cate_id']));?>">编辑</a>&nbsp;&nbsp;|
											<a onClick="return confirm('删除一级分类会将下面的所有二级分类全部删除\n您确定要删除吗?')" href="<?php echo U('life/delSubtype',array('cate_id'=>$var1['cate_id']));?>">删除</a>
										</td>                      
			                        </tr>
			                         <?php if(is_array($list2)): foreach($list2 as $key=>$var2): if($var2["pid"] == $var1["cate_id"] ): ?><tr class="long-td">
			                                    <td style="text-align: center;"><?php echo ($var2["cate_id"]); ?></td>
			                            		<td style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|----<?php echo ($var2["cate_name"]); ?></td>
			                            		<td style="text-align: center;"><?php echo ($var2["orderby"]); ?></td>
			                                    <td style="text-align: center;">
													<a href="<?php echo U('life/editSubtype',array('cate_id'=>$var2['cate_id']));?>">编辑</a>&nbsp;&nbsp;|
													<a onClick="return confirm('您确定要删除吗?')" href="<?php echo U('life/deltype',array('cate_id'=>$var2['cate_id']));?>">删除</a>
			                                    </td>                         
