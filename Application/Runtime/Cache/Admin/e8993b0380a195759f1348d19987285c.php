			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="form-wizard" action="<?php echo U('Advert/edittype',array('id'=>$detail['id']));?>" method="post" class="form-horizontal">
							<div class="form-group">
								<label class="col-sm-2 control-label">标题</label>
								<div class="col-sm-6">
									<input type="text" name="name" value="<?php echo ((isset($detail["name"]) && ($detail["name"] !== ""))?($detail["name"]):''); ?>" placeholder="输入广告标题" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea type="text" name="note" style="height: 150px;" placeholder="输入备注信息" class="form-control"><?php echo ((isset($detail["note"]) && ($detail["note"] !== ""))?($detail["note"]):''); ?></textarea>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-danger" href="<?php echo U('Advert/indextype');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
