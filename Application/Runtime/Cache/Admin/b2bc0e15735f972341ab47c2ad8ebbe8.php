...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	...
	<link rel="stylesheet" href="/Public/Common/umeditor/themes/default/css/umeditor.min.css" type="text/css">
						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									<a href="" class="tip-bottom">网站管理</a> /<a href="<?php echo U('Site/setting');?>" class="current">参数设置</a></p>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="form-wizard" action="<?php echo U('Site/setting');?>" method="post" class="form-horizontal">
							<div class="form-group">
								<label class="col-sm-2 control-label">默认注册上限</label>
								<div class="col-sm-6">
									<input type="text" name="OpenMaxCount" value="<?php echo C('OpenMaxCount');?>" placeholder="输入路由默认注册上限" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">LOGO页面倒计时</label>
								<div class="col-sm-6">
									<input type="text" name="LogoSecond" value="<?php echo C('LogoSecond');?>" placeholder="输入LOGO页面倒计时" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">短信地址</label>
								<div class="col-sm-6">
									<input type="text" name="SmsUrl" value="<?php echo C('SmsUrl');?>" placeholder="输入短信地址" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">企业短信编号</label>
								<div class="col-sm-6">
									<input type="text" name="SmsCode" value="<?php echo C('SmsCode');?>" placeholder="输入短信账号" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="SmsUser" value="<?php echo C('SmsUser');?>" placeholder="输入短信用户名" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="SmsPassword" value="<?php echo C('SmsPassword');?>" placeholder="输入短信密码" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">签到获得积分</label>
								<div class="col-sm-6">
									<input type="text" name="SignCount" value="<?php echo C('SignCount');?>" placeholder="签到获得积分" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">责任声明:</label>
								<div class="col-sm-10">
									<script type="text/plain" id="data_details" name="Message" value="<?php echo C('copyright');?>" style="width:70%;height:200px;"><?php echo C('Message');?></script>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
...
<script>
	...
	<script language="javascript">
	    var um = UM.getEditor('data_details', {
	    imageUrl: "<?php echo U('Upload/editor');?>",
	    imagePath: '/Uploads/',
	    lang: 'zh-cn',
