						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="long-td">
										...
										<td><img src="/lunblog/Uploads/<?php echo ($vo["img"]); ?>" style="width: 180px;height: 70px" /></td>
										<td>
	...
	<div class="modal  fade" id="myModal" tabindex="-1" role="dialog"  aria-hidden="true">
		<div class="modal-dialog">
		    <div class="modal-content">
		        ...
		        <form class="form-horizontal" name="add" id="add" method="post" action="/lunblog/Admin/System/runadd">
		        	<div class="ibox-content">
							...
							<div class="form-group">
								...
								<div><img src="/lunblog/Public/Admin/img/no_img.jpg" height="70" id="img0" ></div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
...
function del(id,p){
	...
	layer.close(index);
	window.location.href="/lunblog/Admin/System/del/id/"+id+"";
	});
}
