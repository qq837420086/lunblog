			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('Liuyan/edit',array('id'=>$detail['id']));?>" name="basic_validate" id="signupForm">							
							<div class="form-group">
								<label class="col-sm-2 control-label">留言昵称</label>
								<div class="col-sm-6">
									<input type="text" name="username" id="username" value="<?php echo ((isset($detail["username"]) && ($detail["username"] !== ""))?($detail["username"]):''); ?>" class="form-control">
								</div>
							</div>												
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea type="text" rows="4" name="content" id="content" class="form-control"><?php echo ((isset($detail["content"]) && ($detail["content"] !== ""))?($detail["content"]):''); ?></textarea>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="from" id="from" value="<?php echo ((isset($detail["from"]) && ($detail["from"] !== ""))?($detail["from"]):''); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="email" id="email" value="<?php echo ((isset($detail["email"]) && ($detail["email"] !== ""))?($detail["email"]):''); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
