	...
	<div class="container padding-top padding-bottom">
		<div class="line">
			<div class="xl12 xs3 xm3 xb2">
				...
				<a href="<?php echo U('Index/index');?>"><img src="/lunblog/Public/Home/images/logo.png" class="ring-hover"/></a>
			</div>
						...
						<div class="xs12">
							<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "暂时没有文章" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix articlebox">
									<div class="detail_a">
										...
										<div class="a_tuijian">
											<?php if($vo["a_red"] == 1): ?><img src="/lunblog/Public/Home/images/tuijian.gif" style="width:70px" /><?php endif; ?>
										</div>
									</div>
									<div class="article">
										<a href="<?php echo U('Article/index',array('a_id'=>$vo['a_id']));?>">
											<img src="/lunblog/Uploads/<?php echo ($vo["photo"]); ?>" onerror="this.src='/lunblog/Public/Home/images/default.jpg'" class="img" title="<?php echo ($v["a_title"]); ?>" width="250px" height="200px" />
										</a>
										<div class="remark">
