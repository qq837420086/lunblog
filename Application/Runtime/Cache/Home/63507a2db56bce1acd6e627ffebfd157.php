...
<div class="main_visual">
					...
					<div class="line-small">
						<div class="xs12">
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix articlebox">
									<div class="detail_a">
										<div class="said_time">
											<span class="icon-paper-plane"></span>&nbsp;<?php echo (tranTime($vo["create_time"])); ?>&nbsp;&nbsp;</span>
											<span class="tag bg-dot"><?php echo ($vo["s_from"]); ?></span>&nbsp;&nbsp;<span class="icon-map-marker"></span>&nbsp;<?php echo ($vo["create_ip"]); ?>
										</div>
									</div>
									<div class="said_img">
										<img src="/lunblog/Uploads/<?php echo ($vo['s_img']); ?>" data-toggle="hover" data-place="right" title="作者：[ <?php echo ($vo["s_writer"]); ?> ],发表自[ <?php echo ($vo["create_ip"]); ?> ]" class="radius-circle tips" width="60px" height="60px" />
										<div class="said_c">
	...
	<div>
		<h3><span class="icon-retweet"></span> 技术支持</h3>
		<br />
		<div class="links">
